...
## Коллекции Postman
На основе майнд-карты были созданы коллекции в Postman с соответствующими запросами. [Ссылка](https://github.com/jsinabdeeva/DummyApi/blob/main/DummyAPI.postman_collection.json) на коллекции.
